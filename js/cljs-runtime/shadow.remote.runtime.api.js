...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29039 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_29039(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_29042 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_29042(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_29047 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_29047(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_29060 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_29060(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29074 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_29074(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29086 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_29086(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__29029,callback){
var map__29030 = p__29029;
var map__29030__$1 = cljs.core.__destructure_map(map__29030);
var input = map__29030__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29030__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29030__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
