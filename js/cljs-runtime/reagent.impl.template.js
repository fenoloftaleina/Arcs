...
var G__36076 = o;
reagent.impl.template.goog$module$goog$object.set(G__36076,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__36333.cljs$lang$applyTo = (function (arglist__36337){
...
var G__36085 = o;
reagent.impl.template.goog$module$goog$object.set(G__36085,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36342__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__36342__delegate.call(this,args);};
...
return G__36342__delegate(args);
});
...
var G__36089 = props;
var G__36089__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36089,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36089);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36089__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36095 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36095,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36095;
}
})(),id_class);
...
var G__36096 = (cljs.core.count(argv) - first_child);
switch (G__36096) {
case (0):
...
var vec__36098 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36098,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36098,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36098,(2),null);
...
var temp__5757__auto___36360 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36360 == null)){
} else {
var key_36361 = temp__5757__auto___36360;
(jsprops.key = key_36361);
}
...
var temp__5757__auto___36362 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36362 == null)){
} else {
var key_36363 = temp__5757__auto___36362;
(jsprops.key = key_36363);
}
...
var temp__5757__auto___36367 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___36367 == null)){
} else {
var key_36368 = temp__5757__auto___36367;
(jsprops.key = key_36368);
}
...
var temp__5757__auto___36371 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___36371 == null)){
} else {
var key_36372 = temp__5757__auto___36371;
...
var temp__5757__auto___36374 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___36374 == null)){
} else {
var key_36382 = temp__5757__auto___36374;
(jsprops.key = key_36382);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36171_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36171_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36192 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36192,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36192,(1),null);
...
break;
default:
var G__36389 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__36390 = compiler;
v = G__36389;
compiler = G__36390;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36291 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36291 = (function (opts,id,fn_to_element,parse_fn,meta36292){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template36291.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36293,meta36292__$1){
var self__ = this;
var _36293__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36291(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta36292__$1));
}));

(reagent.impl.template.t_reagent$impl$template36291.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36293){
var self__ = this;
var _36293__$1 = this;
return self__.meta36292;
}));

(reagent.impl.template.t_reagent$impl$template36291.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36291.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36291.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template36291.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36291.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36291.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta36292","meta36292",-470890877,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36291.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36291.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36291");

(reagent.impl.template.t_reagent$impl$template36291.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template36291");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36291.
 */
reagent.impl.template.__GT_t_reagent$impl$template36291 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36291(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36292){
return (new reagent.impl.template.t_reagent$impl$template36291(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta36292));
});

}

return (new reagent.impl.template.t_reagent$impl$template36291(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
