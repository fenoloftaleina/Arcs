...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29063 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29063(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29066 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29066(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29072 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29072(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29076 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29076(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29085 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29085(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29088 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29088(reader);
}
});
...
var G__29163 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29164 = s.append(c);
c = G__29163;
s = G__29164;
continue;
}
