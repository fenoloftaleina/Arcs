...
var i_29195 = (self__.level + (1));
while(true){
if((i_29195 <= (new_level + (1)))){
(update[i_29195] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29200 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29200[i]));
} else {
x__$2.forward.push((((i < links_29200.length))?(links_29200[i]):null));
}

if((i < links_29200.length)){
(links_29200[i] = x__$2);
} else {
links_29200.push(x__$2);
}
...
var i_29213 = (0);
while(true){
if((i_29213 <= self__.level)){
var links_29214 = (update[i_29213]).forward;
if((x__$1 === (((i_29213 < links_29214.length))?(links_29214[i_29213]):null))){
(links_29214[i_29213] = (x__$1.forward[i_29213]));

var G__29218 = (i_29213 + (1));
i_29213 = G__29218;
continue;
} else {
var G__29219 = (i_29213 + (1));
i_29213 = G__29219;
continue;
}
} else {
...
var G__29222 = nx;
var G__29223 = (level__$1 - (1));
x = G__29222;
level__$1 = G__29223;
continue;
} else {
var G__29224 = x;
var G__29225 = (level__$1 - (1));
x = G__29224;
level__$1 = G__29225;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__29232 = nx;
var G__29233 = (level__$1 - (1));
x = G__29232;
level__$1 = G__29233;
continue;
} else {
var G__29234 = x;
var G__29235 = (level__$1 - (1));
x = G__29234;
level__$1 = G__29235;
continue;
}
